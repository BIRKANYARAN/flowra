...
const IL  = 'w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 bg-white'
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
        ...
        <div className="space-y-4">
          ...
          <button onClick={handle} disabled={loading}
            className="w-full bg-primary-600 text-white py-2.5 rounded-xl text-sm font-bold hover:bg-primary-700 disabled:opacity-50 transition-colors">
