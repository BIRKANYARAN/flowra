  ...
  return (
    <div className="flex items-center justify-center gap-3 mb-6 print:hidden">
      <button
        ...
        className="flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-100 rounded text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm disabled:opacity-50"
      >
