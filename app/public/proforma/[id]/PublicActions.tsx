  ...
  return (
    <div className="flex items-center justify-center gap-3 mb-6 print:hidden">
      <button
        ...
        className="flex items-center gap-2 px-5 py-2.5 bg-white border border-[#e2e8f0] rounded-xl shadow-soft text-sm font-medium text-[#334155] hover:bg-[#f8fafc] transition-colors shadow-sm disabled:opacity-50"
      >
      ...
      <button
        onClick={handleDownload}
        disabled={downloading}
        className="flex items-center gap-2 px-5 py-2.5 bg-brand rounded text-sm font-medium text-white hover:bg-brand-light transition-colors shadow-sm disabled:opacity-50"
      >
        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
