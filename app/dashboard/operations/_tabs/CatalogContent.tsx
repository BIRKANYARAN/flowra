          ...
          <div className="flex items-center justify-end px-4 py-3 border-b border-[#f1f5f9]">
            <div className="flex items-center gap-4 text-xs">
              <div className="text-right">
                ...
                <div className="font-bold tabular-nums text-[#0f172a]">{fmtTRY(marginReport.total_revenue_try)}</div>
              </div>
              <div className="text-right">
            ...
            <div className="flex gap-4 px-4 py-2 border-b border-[#f1f5f9] text-[10px]">
              {marginReport.top_margin_product && (
                <span className="text-pos-text">
                  <span className="font-bold">En yüksek marj:</span> {marginReport.top_margin_product}
                </span>
              )}
              {marginReport.lowest_margin_product && marginReport.products.length > 1 && (
                <span className="text-neg">
                  <span className="font-bold">En düşük marj:</span> {marginReport.lowest_margin_product}
                </span>
              )}
            </div>
          )}
