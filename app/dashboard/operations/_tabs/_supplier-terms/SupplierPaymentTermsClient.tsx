  ...
  return (
    <tr className="hover:bg-[#f8fafc]/60 border-b border-[#f1f5f9] last:border-0">
      ...
      <td className="px-3 py-2.5 text-right">
        <span className={`text-xs font-bold tabular-nums ${scoreTextColor(s.payment_score)}`}>
          {s.payment_score}
        </span>
      </td>
      <td className="px-3 py-2.5 text-center">
        <span className={`inline-flex items-center px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-wide ${CLASS_BADGE[s.payment_class]}`}>
    ...
    <div className="bg-white border border-[#e8eaef] rounded-xl shadow-soft shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-3 border-b border-[#e8eaef]">
        ...
        <div className="px-4 py-3 text-center">
          ...
          <div className={`text-xl font-bold tabular-nums ${summary.total_outstanding_try > 0 ? 'text-[#991b1b]' : 'text-[#94a3b8]'}`}>
        ...
        <div className="px-4 py-3 text-center">
          ...
          <div className={`text-xl font-bold tabular-nums ${scoreTextColor(summary.overall_payment_score)}`}>
      ...
      <div className="px-4 py-3 border-b border-[#e8eaef]">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <span className={`text-xs font-bold tabular-nums ${scoreTextColor(summary.overall_payment_score)}`}>
            ...
            <table className="w-full text-xs min-w-[500px]">
              <thead>
                <tr className="bg-[#f8fafc] border-b border-[#e8eaef]">
                  ...
                  <th className="text-right px-3 py-2 text-[0.65rem] font-bold uppercase tracking-wider text-[#94a3b8]">Toplam</th>
                  <th className="text-right px-3 py-2 text-[0.65rem] font-bold uppercase tracking-wider text-[#94a3b8]">Bekleyen</th>
                  <th className="text-right px-3 py-2 text-[0.65rem] font-bold uppercase tracking-wider text-[#94a3b8]">Ort. Gün</th>
                  <th className="text-right px-3 py-2 text-[0.65rem] font-bold uppercase tracking-wider text-[#94a3b8]">Skor</th>
                  <th className="text-center px-3 py-2 text-[0.65rem] font-bold uppercase tracking-wider text-[#94a3b8]">Sınıf</th>
                </tr>
              </thead>
