    ...
    <div className="bg-white border border-[#e8eaef] rounded-xl shadow-soft shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-0 border-b border-[#f1f5f9]">
        ...
        <div className="p-3 border-b sm:border-b-0 sm:border-r border-[#e8eaef]">
          ...
          <div className={`text-xl font-bold tabular-nums leading-none ${hhiTextColor(report.concentration_level)}`}>
        ...
        <div className="p-3 border-b sm:border-b-0 sm:border-r border-[#e8eaef]">
          ...
          <div className="text-xl font-bold tabular-nums leading-none text-[#0f172a]">
        ...
        <div className="p-3">
          ...
          <div className={`text-xl font-bold tabular-nums leading-none ${report.top_3_spend_pct > 60 ? 'text-[#991b1b]' : 'text-[#0f172a]'}`}>
