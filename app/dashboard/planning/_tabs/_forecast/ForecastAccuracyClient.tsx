...
export function ForecastAccuracyClient({ companyId }: Props) {
  ...
  if (variances.length === 0) {
    return (
      <div className="bg-white border border-[#e2e8f0] rounded p-8 text-center space-y-2">
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {/* MAPE */}
        <div className="bg-white border border-[#e2e8f0] rounded p-4 space-y-1">
      ...
      <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded p-4 grid grid-cols-2 gap-4 sm:grid-cols-4 text-xs">
        ...
        <div>
          ...
          <div className="font-black text-pos-text">
