...
export default function PipelineVelocityClient({ companyId }: Props) {
  ...
  if (isLoading) {
    return (
      <div className="animate-pulse space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-0 bg-white border border-[#e2e8f0] rounded overflow-hidden h-24" />
  ...
  return (
    <div className="space-y-4">
      ...
      {/* KPI Cards */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-0 bg-white border border-[#e2e8f0] rounded overflow-hidden divide-x divide-y sm:divide-y-0 divide-[#e2e8f0]">
        <KpiCard
          label="Dönüşüm Oranı"
