          ...
          <div className="pb-3 border-b border-[#f1f5f9]">
            <div className="flex flex-wrap gap-4 items-center">
              <div>
                ...
                <div className="text-lg font-bold tabular-nums text-[#0f172a]">{fmt(attribution.total_revenue_try)}</div>
              </div>
              {attribution.top3_customer_pct !== null && (
                <div>
                  <span className="text-[10px] text-[#94a3b8]">İlk 3 Müşteri</span>
                  <div className="text-lg font-bold tabular-nums text-[#0f172a]">%{attribution.top3_customer_pct.toFixed(1)}</div>
                </div>
              )}
              {attribution.top3_product_pct !== null && attribution.by_product.length > 0 && (
                <div>
                  <span className="text-[10px] text-[#94a3b8]">İlk 3 Ürün</span>
                  <div className="text-lg font-bold tabular-nums text-[#0f172a]">%{attribution.top3_product_pct.toFixed(1)}</div>
                </div>
              )}
              <div>
                <span className="text-[10px] text-[#94a3b8]">Yeni Müşteri Cirosu</span>
                <div className="text-lg font-bold tabular-nums text-pos-text">{fmt(attribution.new_customer_revenue_try)}</div>
              </div>
              <div>
                <span className="text-[10px] text-[#94a3b8]">Mevcut Müşteri Cirosu</span>
                <div className="text-lg font-bold tabular-nums text-[#0f172a]">{fmt(attribution.returning_customer_revenue_try)}</div>
              </div>
            </div>
          </div>
              ...
              <div className="p-4 flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-[#f0fdf4] rounded p-3">
                    ...
                    <div className="text-base font-bold tabular-nums text-pos-text">{fmt(attribution.new_customer_revenue_try)}</div>
                  ...
                  <div className="bg-[#f8fafc] rounded p-3">
                    ...
                    <div className="text-base font-bold tabular-nums text-[#0f172a]">{fmt(attribution.returning_customer_revenue_try)}</div>
                    {attribution.total_revenue_try > 0 && (
                      <div className="text-[10px] text-[#94a3b8]">
