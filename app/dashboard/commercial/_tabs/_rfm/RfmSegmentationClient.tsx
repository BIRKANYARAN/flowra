          ...
          return (
            <div key={seg} className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <span className="text-[11px] font-bold tabular-nums text-[#334155] w-5 text-right">
                  {count}
                </span>
              ...
              return (
                <tr key={c.customer_id} className="hover:bg-[#f8fafc]/60">
                  ...
                  <td className="px-3 py-2.5 text-center">
                    <span className="inline-block bg-[#f1f5f9] text-[#334155] text-[11px] font-bold tabular-nums px-2 py-0.5 rounded font-mono">
                      {c.rfm_code}
                    </span>
                  </td>
                  <td className="px-3 py-2.5 text-center">
        ...
        <div className="flex items-center justify-between px-4 py-2 border-t border-[#f8fafc]">
          ...
          <div className="flex gap-1">
            <button
              ...
              disabled={page === 0}
              className="text-[10px] px-2 py-0.5 rounded border border-[#e8eaef] disabled:opacity-30 text-[#64748b]"
            >
              ‹ Önceki
            </button>
            <button
          ...
          return (
            <div key={c.customer_id} className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                <span className="text-[10px] font-bold tabular-nums text-brand w-20 text-right">
                  {fmtTRY(c.total_spend)}
                </span>
