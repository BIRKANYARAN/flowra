...
export default async function CommercialPage({ searchParams }: PageProps) {
  ...
  if (!userId) return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-3 text-center px-4">
      ...
      <a href="/dashboard/commercial" className="text-sm text-primary-600 font-semibold hover:underline">Yeniden Dene</a>
    </div>
  )
  ...
  return (
    <div className="flex flex-col gap-5 max-w-5xl">
      ...
      {/* PAGE HERO */}
      <div>
        <div className="text-[10px] font-black uppercase tracking-widest text-[#94a3b8] mb-1">Ticari Akış Merkezi</div>
