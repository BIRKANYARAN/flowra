      ...
      <div className="bg-white border border-[#e8eaef] rounded-xl shadow-soft p-4 shadow-sm">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={t.label}>
              ...
              <div className={`text-lg font-bold tabular-nums ${t.color ?? 'text-[#334155]'}`}>{t.value}</div>
            </div>
          ))}
        </div>
        <div className="mt-4 pt-4 border-t border-[#e8eaef] grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          <div>
            ...
            <div className="text-lg font-bold tabular-nums text-neg">{fmtC(toDisplay(yearly.yearlyExpenses), S)}</div>
          ...
          <div>
            ...
            <div className={`text-lg font-bold tabular-nums ${yearly.totalNetProfit >= 0 ? 'text-pos-text' : 'text-neg'}`}>
          ...
          <div>
            ...
            <div className={`text-lg font-bold tabular-nums ${yearly.avgMargin >= 0 ? 'text-brand' : 'text-neg'}`}>
          ...
          {yearly.breakEvenUnits > 0 && (
            <div>
              ...
              <div className="text-lg font-bold tabular-nums text-warn-text">
