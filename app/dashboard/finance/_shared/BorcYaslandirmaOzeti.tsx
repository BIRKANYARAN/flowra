    ...
    <div className="bg-white border border-[#e8eaef] rounded-xl shadow-soft p-4 shadow-sm">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="text-right">
          <div className="text-sm font-bold tabular-nums text-[#0f172a]">{fmt(report.total_outstanding_try)}</div>
        ...
        <table className="w-full text-xs">
          ...
          <tbody className="divide-y divide-[#f8fafc]">
            ...
            <tr className="bg-[#f8fafc] border-t-2 border-[#e8eaef]">
              <td className="px-3 py-1.5 font-bold text-[#0f172a]">Toplam</td>
              <td className="px-3 py-1.5 text-right font-mono font-bold tabular-nums text-[#0f172a]">
