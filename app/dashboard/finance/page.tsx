...
//
// FAZ T2: Unified 8-tab financial workspace
//
...
import { FinanceInnerTabs }  from '@/components/dashboard/FinanceInnerTabs'
import type { FinanceTab }   from '@/components/dashboard/FinanceInnerTabs'
...
const VALID_TABS: FinanceTab[] = [
  'overview', 'pnl', 'balance', 'cashflow', 'tax', 'risks', 'forecast', 'quarterly',
]
...
export default async function FinancePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="flex flex-col gap-4 max-w-6xl">
      ...
      {/* ── Tab navigation ────────────────────────────────────────────────────── */}
      <FinanceInnerTabs active={activeTab} />
