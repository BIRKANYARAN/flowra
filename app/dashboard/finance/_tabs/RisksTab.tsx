...
//
// NEW tab — powered by lib/finance/risk-engine.ts
//
// Zones:
//   1. Risk özeti (4 KPIs: total, overdue, concentration, HHI)
//   2. Konsantrasyon sinyali (top 3 + pie-style bar)
//   3. Müşteri yaşlandırma tablosu (aging by customer)
//   4. Risk tavsiyesi (dynamic guidance based on levels)
