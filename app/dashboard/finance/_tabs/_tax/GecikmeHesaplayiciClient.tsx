        ...
        {result && (
          <div className={`rounded border px-4 py-3 grid grid-cols-3 gap-4 ${
            ...
            <div className="text-center">
              ...
              <div className={`text-xl font-bold tabular-nums ${result.days > 0 ? 'text-neg' : 'text-pos-text'}`}>
                {result.days} gün
              </div>
            </div>
            <div className="text-center border-x border-[#e8eaef]">
              ...
              <div className={`text-xl font-bold tabular-nums ${result.faiz > 0 ? 'text-neg' : 'text-pos-text'}`}>
                {formatTRY(result.faiz)}
              </div>
            </div>
            <div className="text-center">
              <div className="text-[0.65rem] font-bold uppercase tracking-wider text-[#94a3b8] mb-1">Toplam Ödeme</div>
              <div className="text-xl font-bold tabular-nums text-warn-text">
