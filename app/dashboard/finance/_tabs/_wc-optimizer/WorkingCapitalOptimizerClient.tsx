    ...
    <div className="bg-white border border-[#e8eaef] rounded-xl shadow-soft overflow-hidden">
      ...
      <div className="px-4 py-3 grid grid-cols-3 gap-4 bg-[#f8fafc]">
        <div className="text-center">
          ...
          <div className="text-xl font-black tabular-nums text-[#ef4444]">{Math.round(gap.actual_days)}</div>
        ...
        <div className="text-center">
          ...
          <div className="text-xl font-black tabular-nums text-[#10b981]">{Math.round(gap.benchmark_days)}</div>
          <div className="text-[10px] text-[#94a3b8]">gün</div>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#e8eaef] rounded-xl shadow-soft px-4 py-4">
        <div className="grid grid-cols-3 gap-4 mb-4">
          <div className="text-center">
            ...
            <div className="text-2xl font-black tabular-nums text-[#ef4444]">{currentCcc}</div>
            <div className="text-[10px] text-[#94a3b8]">gün</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-black tabular-nums text-[#10b981]">{targetCcc}</div>
            <div className="text-[10px] text-[#94a3b8]">gün</div>
          </div>
        </div>
