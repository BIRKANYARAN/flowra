    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#e8eaef] rounded-xl shadow-soft">
          ...
          <span className="text-sm font-bold tabular-nums text-[#0f172a]">{fmt(curTotal)}</span>
        ...
        {prevTotal > 0 && (
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#e8eaef] rounded-xl shadow-soft">
            ...
            <span className="text-sm font-bold tabular-nums text-[#64748b]">{fmt(prevTotal)}</span>
          </div>
        )}
        ...
        {dailyRate > 0 && (
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#e8eaef] rounded-xl shadow-soft">
            ...
            <span className="text-sm font-bold tabular-nums text-warn-text">{fmt(dailyRate)}</span>
