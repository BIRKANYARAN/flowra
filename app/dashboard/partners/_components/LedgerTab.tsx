                ...
                <tr className="border-b border-[#e8eaef] bg-[#f8fafc]">
                  {([
                    ...
                    return (
                      <th
                        key={h.label}
                        className={`px-4 py-2.5 text-[0.65rem] font-bold uppercase tracking-wider ${isSorted ? 'text-brand-light' : 'text-[#94a3b8]'} ${isLeft ? 'text-left' : 'text-right'} ${h.col ? 'cursor-pointer select-none hover:text-[#64748b]' : ''}`}
