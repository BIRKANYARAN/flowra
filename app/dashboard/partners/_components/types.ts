...
export type TabId = 'partners' | 'ledger' | 'waterfall' | 'tranches' | 'distribution' | 'returns' | 'risk' | 'capital' | 'dividend' | 'compensation' | 'dilution' | 'amortization' | 'dividend-ledger' | 'capital-statement'
