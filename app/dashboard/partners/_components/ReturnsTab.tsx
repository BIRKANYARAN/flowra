        ...
        <>
          <div className="bg-white border border-[#e8eaef] rounded-xl shadow-soft overflow-hidden shadow-sm">
            <div className="px-4 py-2.5 border-b border-[#e8eaef] bg-[#f8fafc]">
              <div className="text-[0.65rem] font-bold uppercase tracking-wider text-[#94a3b8]">Ortak Bazında Sermaye Getirisi</div>
            </div>
                ...
                <div key={r.partner_id} className="px-4 py-4">
                  <div className="flex items-start justify-between gap-4 mb-2">
                    ...
                    <div className="text-right shrink-0">
                      <div className={`text-lg font-bold tabular-nums ${r.roi_to_date_pct >= 100 ? 'text-pos-text' : r.roi_to_date_pct >= 50 ? 'text-warn-text' : 'text-neg'}`}>
