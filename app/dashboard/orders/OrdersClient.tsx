...
export function OrdersClient(_props: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ── Status filter tabs ──────────────────────────────────────────── */}
      <div className="flex items-center gap-1 border-b border-[#e8eaef] pb-0">
        {STATUS_TABS.map(tab => (
          <button
            key={tab.key}
            ...
            {formItems.map((item, idx) => (
              <div key={idx} className="grid grid-cols-[2fr_1fr_1fr_1fr_auto] gap-2 mb-2">
                <input
                  ...
                  className="border border-[#e8eaef] rounded px-2 py-1.5 text-xs"
                ...
                <input
                  ...
                  className="border border-[#e8eaef] rounded px-2 py-1.5 text-xs text-right"
                  placeholder="Miktar"
                />
                <input
