  ...
  return (
    <div className="max-w-5xl space-y-4">
      <div className="flex items-center gap-3">
        <h1 className="text-lg font-black text-gray-900 tracking-tight">Sipariş Operasyonları</h1>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center">
        ...
        <h2 className="text-base font-bold text-gray-800 mb-1">Sipariş Yönetimi</h2>
        <p className="text-sm text-gray-500 mb-4 max-w-sm mx-auto">
          Satın alma siparişleri, tedarikçi ilişkileri ve envanter yönetimi bu sayfada birleşecek.
        </p>
