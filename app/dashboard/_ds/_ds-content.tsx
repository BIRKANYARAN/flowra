...
// Client component: Design System showcase content.
// Only rendered in development — the server page.tsx calls notFound() in production.

import { Btn, Card, Label, SectionHeader, DSInput, StatusBadge, Money } from '@/components/ui'
