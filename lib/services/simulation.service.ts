...
// ═══════════════════════════════════════════════════════════════════════════════
// ENHANCED PURE HELPERS — seasonal distribution, DSR, scenario comparison
//
// Definitions moved to ./simulation.pure (client-safe, no server imports) so
// 'use client' components can import them without pulling this server-only
// service into the bundle. Re-exported here to preserve the public API.
// ═══════════════════════════════════════════════════════════════════════════════
