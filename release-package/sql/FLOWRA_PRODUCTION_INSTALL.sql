...
-- ════════════════════════════════════════════════════════════════════════════
-- DRIFT FOLD — Governance Foundation (migration 20260608000001) — fresh-install parity
-- corporate_actions + governance_resolutions + governance_obligations.
-- ════════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════════
-- DRIFT FOLD — Forward Commitments (migration 20260608000002) — fresh-install parity
-- ════════════════════════════════════════════════════════════════════════════
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ════════════════════════════════════════════════════════════════════════════
-- DRIFT FOLD — Audit Readiness ack table (migration 20260608000004) — fresh-install parity
-- ════════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════════
-- DRIFT FOLD — recurring_expenses (migration 20260608000006) — fresh-install parity
-- ════════════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════════════
-- DRIFT FOLD — product_cost_entries (migration 20260610000001) — fresh-install parity
-- ════════════════════════════════════════════════════════════════════════════
