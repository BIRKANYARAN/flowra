...
export function PrintButton({ label = 'PDF İndir' }: { label?: string }) {
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#0f172a] text-white text-xs font-semibold hover:bg-[#334155] transition-colors print:hidden"
    >
